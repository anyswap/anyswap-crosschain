...
export const POLYGONZKEVM_MAINNET = getLocalRPC(POLYGONZKEVM_MAIN_CHAINID, 'https://zkevm-rpc.com')
export const POLYGONZKEVM_MAIN_EXPLORER = 'https://zkevm.polygonscan.com'
