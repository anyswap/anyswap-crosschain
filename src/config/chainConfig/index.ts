...
import neb, { NEBULAS_MAIN_CHAINID } from './neb'
...
const useChain: any = {
  ...
  [VERSION.V2]: [ETH_MAIN_CHAINID, BNB_MAIN_CHAINID, FTM_MAIN_CHAINID, MATIC_MAIN_CHAINID],
  [VERSION.V2_1]: [ETH_MAIN_CHAINID, BNB_MAIN_CHAINID, FTM_MAIN_CHAINID, MATIC_MAIN_CHAINID],
  [VERSION.V2_2]: [
    ETH_MAIN_CHAINID,
    BNB_MAIN_CHAINID,
    FTM_MAIN_CHAINID,
  ...
  [VERSION.V2_T2]: [ETH_TEST_CHAINID, ARBITRUM_TEST_CHAINID, OMGX_TEST_CHAINID, OPTIMISM_TEST_CHAINID],
  [VERSION.V2_T3]: [ETH_TEST_CHAINID, ARBITRUM_TEST_CHAINID, OMGX_TEST_CHAINID, OPTIMISM_TEST_CHAINID],
