...
export const BNB_MAINNET =
  process.env.NODE_ENV === 'development'
    ...
    : getLocalRPC(BNB_MAIN_CHAINID, 'https://bscrpc.com	')
export const BNB_MAIN_EXPLORER = 'https://bscscan.com'
// console.log(BNB_MAINNET)
export const BNB_TEST_CHAINID = 97
export const BNB_TESTNET = getLocalRPC(BNB_TEST_CHAINID, 'https://data-seed-prebsc-2-s3.binance.org:8545/')
...
export default {
  ...
  [BNB_TEST_CHAINID]: {
    wrappedToken: '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd',
    storage: '0xF0BCf27a2203E7E8c1e9D36F40EF2C5A8a6E7D0B',
