...
import SelectCurrencyInputPanel from '@/src/components/CurrencySelect/selectCurrency'
import { AutoColumn } from '@/src/componentColumn'
// import { ButtonLight, ButtonPrimary, ButtonConfirmed } from '@/src/components/Button'
import { ButtonLight, ButtonPrimary, ButtonConfirmed } from '@/src/component/Button'
import { AutoRow } from '@/src/componentRow'
// import Loader from '@/src/components/Loader'
import AddressInputPanel from '@/src/component/AddressInputPanel'
import { ArrowWrapper, BottomGrouping } from '@/src/component/swap/styleds'
import ModalContent from '@/src/component/Modal/ModalContent'
...
import config from '@/src/component'
import { getParams } from '@/src/component/tools/getUrlParams'
import { selectNetwork } from '@/src/component/tools/methods'
import { ChainId } from '@/src/component/chainConfig/chainId'
...
export default function CrossChain({ bridgeKey }: { bridgeKey: any }) {
  ...
  const { allowance, loading, setNonevmAllowance } = useNonevmAllowances(
    isApprove,
    selectCurrency,
    destConfig?.spender,
    chainId,
  ...
  const { initDestCurrency, initDestCurrencyList } = useDestCurrency(
    selectCurrency,
