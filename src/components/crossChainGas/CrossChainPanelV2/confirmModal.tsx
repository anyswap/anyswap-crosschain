...
export default function ConfirmContent({
  ...
  return (
    <>
      <ConfirmBox>
        <ConfirmTip>Please review and confirm the details</ConfirmTip>
        <ConfirmList>
          <li className="item">
          ...
          <li className="item">
            <div className="label">
              <TokenLogo
                symbol={config.getCurChainInfo(fromChainId)?.networkLogo ?? config.getCurChainInfo(fromChainId)?.symbol}
                size={'24px'}
              />
              <div className="cont">
        ...
        <ConfirmList>
          ...
          <li className="item">
            <div className="label">
              <TokenLogo
                symbol={config.getCurChainInfo(toChainId)?.networkLogo ?? config.getCurChainInfo(toChainId)?.symbol}
                size={'24px'}
              />
              <div className="cont">
          ...
          {destConfig?.MaximumSwapFee === destConfig?.MinimumSwapFee ? (
            <>
              ...
              <li className="item">
                <div className="label">
                  Gas Fee:
                  <QuestionHelper text={'for your cross-chain transaction on destination chain'} />
                </div>
            ...
            <>
              <li className="item">
                ...
                <div className="value">
                  {fee + ' ' + selectCurrency?.symbol}({useDfee} %)
                </div>
              </li>
            </>
          )}
